              ...
              <div className="grid gap-8 lg:grid-cols-4 sm:grid-cols-2 md:grid-cols-3 grid-cols-1 self-start">
                  {
                    [...books].reverse().map(book =>
                      ...
                      <Card className="h-full flex flex-col">
                        <div className="overflow-hidden rounded-t-md h-44 w-full bg-gray-100">
                          <img src={book.imageUrl} alt={book.title} className="w-full h-full object-cover" onError={(e)=>{e.target.src='/assets/banner-books/book1.png'}}/>
                        </div>
                        <div className='p-4 flex-1 flex flex-col'>
                          <h5 className="text-lg font-bold tracking-tight text-gray-900 dark:text-white">
                            {book.title}
                          </h5>
                          <p className="font-normal text-gray-700 dark:text-gray-400 mt-2 flex-1 overflow-hidden" style={{maxHeight:'4rem'}}>
                            {book.bookDescription.split(' ').slice(0, 12).join(' ')}
                          </p>
                          <button className=' mt-5 bg-blue-700 text-white font-semibold px-5 py-2 rounded hover:bg-black transition-all duration-300 mt-auto'>Buy Now</button>
                        </div>
                      </Card>
